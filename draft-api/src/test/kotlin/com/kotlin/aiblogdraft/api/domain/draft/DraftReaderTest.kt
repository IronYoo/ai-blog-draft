...
class DraftReaderTest(
    ...
    private val draftReader: DraftReader,
        ...
        given("유저의 초안 조회 시") {
            val draft1 = draftRepository.save(DraftEntity(com.kotlin.aiblogdraft.storage.db.enum.DraftEntityType.RESTAURANT, "title1", 1L))
            val draft2 = draftRepository.save(DraftEntity(com.kotlin.aiblogdraft.storage.db.enum.DraftEntityType.RESTAURANT, "title2", 1L))
            When("정상적인 요청이면") {
